...
* **The interactive R console** (entire left)
 ...
 The console is used to write instructions or lines of code to the computer. These instructions may be things like reading in data or plotting data and will be performed by the computer as soon as you press the ENTER key. Be aware that the instructions you type in the console will not be saved for later use.
